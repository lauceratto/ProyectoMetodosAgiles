...
public class PanelModificacionInmueble extends JPanel {
	...
	private JLabel lblBanios;
	private JTextField txtBanios;
	
	public PanelModificacionInmueble(Login login) {

			setLayout(null);
			
			JPanel panel = new JPanel();
			panel.setBorder(new TitledBorder(new EtchedBorder(EtchedBorder.LOWERED, new Color(255, 255, 255), new Color(160, 160, 160)), "Modificar Imueble", TitledBorder.LEADING, TitledBorder.TOP, null, new Color(0, 0, 0)));
			...
			lblBanios = new JLabel("Cant. ba\u00F1os");
			...
			//DATOS
			this.listaPropietario.addItem("Jose Perez");
			this.listaPropietario.setSelectedItem("Jose Perez");
			this.listaProvincia.setSelectedItem("Santa Fe");
			this.listaLocalidad.addItem("Santa Fe");
			this.listaLocalidad.setSelectedItem("Santa Fe");
			this.listaCalle.addItem("Urquiza");
			this.listaCalle.setSelectedItem("Urquiza");
			this.txtNumero.setText("2643");
			this.txtPiso.setText("PB");
			this.listaBarrio.addItem("Barrio Sur");
			this.listaBarrio.setSelectedItem("Barrio Sur");
			this.listaTipo.addItem("Casa");
			this.listaTipo.setSelectedItem("Casa");
			this.txtPrecio.setText("5000000");
			this.txtLongitudFrente.setText("5");
			this.txtLongitudFondo.setText("7");
			this.txtSuperficie.setText("35");
			this.txtAntiguedad.setText("6");
			this.txtDormitorios.setText("2");
			this.txtBanios.setText("1");
			this.checkPatio.setSelected(true);
			this.checkAguaCorriente.setSelected(true);
			this.checkGas.setSelected(true);
			this.checkLavadero.setSelected(true);
			this.checkPavimento.setSelected(true);
			this.checkCloacas.setSelected(true);
			this.checkAguaCaliente.setSelected(true);
	}
