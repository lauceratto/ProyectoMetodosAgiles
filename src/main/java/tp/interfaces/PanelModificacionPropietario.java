		...
		gl_panelModificacionPropietario.setHorizontalGroup(
			gl_panelModificacionPropietario.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_panelModificacionPropietario.createSequentialGroup()
					.addGap(36)
					.addGroup(gl_panelModificacionPropietario.createParallelGroup(Alignment.LEADING)
				...
				.addGroup(gl_panelDireccion.createSequentialGroup()
					...
					.addGroup(gl_panelDireccion.createParallelGroup(Alignment.LEADING)
						.addGroup(gl_panelDireccion.createSequentialGroup()
							...
							.addComponent(lblLocalidad, GroupLayout.PREFERRED_SIZE, 61, GroupLayout.PREFERRED_SIZE))
						.addGroup(gl_panelDireccion.createSequentialGroup()
							.addGap(125)
							.addComponent(lblNumero, GroupLayout.PREFERRED_SIZE, 35, GroupLayout.PREFERRED_SIZE)
							.addPreferredGap(ComponentPlacement.RELATED, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
							.addComponent(txtNumero, GroupLayout.PREFERRED_SIZE, 55, GroupLayout.PREFERRED_SIZE)
							.addGap(28)
							.addComponent(lblDepartamento, GroupLayout.PREFERRED_SIZE, 46, GroupLayout.PREFERRED_SIZE)
							.addPreferredGap(ComponentPlacement.RELATED)
							.addComponent(txtDepartamento, GroupLayout.PREFERRED_SIZE, 46, GroupLayout.PREFERRED_SIZE)
							.addGap(1)))
					.addGroup(gl_panelDireccion.createParallelGroup(Alignment.TRAILING)
						.addGroup(Alignment.LEADING, gl_panelDireccion.createSequentialGroup()
							.addPreferredGap(ComponentPlacement.RELATED)
							.addComponent(comboLocalidad, 0, 213, Short.MAX_VALUE))
						.addGroup(Alignment.LEADING, gl_panelDireccion.createSequentialGroup()
							.addGap(30)
							.addComponent(lblPiso, GroupLayout.PREFERRED_SIZE, 38, GroupLayout.PREFERRED_SIZE)
							.addPreferredGap(ComponentPlacement.RELATED)
							.addComponent(txtPiso, GroupLayout.PREFERRED_SIZE, 57, GroupLayout.PREFERRED_SIZE)))
					.addContainerGap())
		);
			...
			gl_panelDireccion.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_panelDireccion.createSequentialGroup()
					...
					.addGroup(gl_panelDireccion.createParallelGroup(Alignment.BASELINE)
						...
						.addComponent(txtPiso, GroupLayout.PREFERRED_SIZE, 20, GroupLayout.PREFERRED_SIZE))
